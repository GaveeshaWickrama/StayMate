  ...
  return (
    ...
    <div className="bg-white p-10 rounded-lg shadow-2xl w-full max-w-2xl">
      <form className="space-y-6" onSubmit={handleSave} encType="multipart/form-data">
        ...
        <div>
          <label className="block text-gray-700 font-semibold">NIC/Passport</label>
          <input
            type="text"
            name="nicPassport"
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center justify-center w-full">
            <label
              htmlFor="file-upload"
              className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-400 rounded-lg cursor-pointer hover:bg-gray-100"
            >
              {previewUrl ? (
                <img src={previewUrl} alt="Profile Preview" className="max-w-full max-h-full object-contain rounded-lg" />
              ) : (
                <>
                  <svg
