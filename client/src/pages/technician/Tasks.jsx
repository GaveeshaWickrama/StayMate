...
function NoJobs() {
  return (
    <div className="text-center mt-20">
      <p className="text-lg text-gray-700 items-center">no jobs found</p>
    ...
    <div className="bg-gray-100 mx-auto py-2 px-8">
      ...
      <div className="bg-white rounded-lg overflow-hidden mb-4">
        <table className="table w-full">
          ...
          <tbody>
            {console.log("this is the jobs length", filteredData.length)}

            {filteredData.length === 0
              ? console.log("complaint length is zero")
              : console.log("comnplaint length is not zero")}
...
export default function Test() {
    ...
    const fetchJobs = async () => {
      ...
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/technicians/${technicianID}/jobs`
        );
  ...
  console.log("these are all the jobs", jobs);
