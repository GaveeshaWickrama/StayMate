...
const UserTile = ({ user, complaintId }) => (
    <Link to={{
...
function ExploreTechnicians() {
    ...
    useEffect(() => {
        handleFilterChange();
    }, [searchQuery, skillFilter, locationFilter, ratingsSort, activeJobsSort, users]);
        ...
        <div className="container mx-auto p-10">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8 cursor-pointer">
                    {currentUsers.length ? currentUsers.map(user => <UserTile key={user._id} user={user} complaintId={complaintId} />) : <NoTechnicians />}
                </div>
