...
const MyProfile = () => {
     ...
     const fetchRequests = async () => {
      const data = [
              ...
              { id: 1, name:"chamu",profession:"plumber", email:"chamu@gmail.com",address:"colombo",nic:"2001",contactNumber:"071" },
              { id: 2, name:"chamu",profession:"plumber", email:"chamu@gmail.com",address:"colombo",nic:"2001",contactNumber:"071"}
...
useEffect(()=>{
    ...
    return ( 
        const {email,contactNumber,address, nic} = data;
        data.map((data)=>{});
