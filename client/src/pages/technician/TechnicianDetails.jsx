...
//       console.log('Request sent to the technician');
...
function TechnicianDetails() {
  ...
  const mockTechnician = {
    ...
    proPic: "technician.jpg",
    createdAt: "2023-01-15T00:00:00Z",
    about:
      "Experienced technician with a strong background in electrical engineering.",
    location: {
