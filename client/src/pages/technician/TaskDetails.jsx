      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="w-full md:w-2/3 rounded-lg p-1 bg-white shadow">
          <div className="bg-white p-8 flex flex-row justify-between items-center border-b">
            <div className="flex flex-row items-center">
              ...
              <p className="ml-4 badge badge-ghost bg-yellow-200">{complaint.status}</p>
            </div>
        ...
        <div className="flex items-center p-6 gap-4">
          ...
          <div className="flex items-base p-6 gap-4">
            ...
            <div className='text-xl card'> {complaint.reservationId.property.host_id.firstName} {complaint.reservationId.property.host_id.lastName}</div>
          </div>

          <div className="flex items-center  bg-blue-100 rounded-xl p-8">
            <div className="flex flex-col items-center mr-4">
              <img
               src={`${import.meta.env.VITE_API_URL}/uploads/profilePictures/2.jpeg`}
                alt="Host"
            ...
            <h3 className="text-lg font-bold">
              ...
              <div className="text-gray-500 mb-4 items-center"><span className="block text-black">Joined On</span> 
              {new Date(complaint.reservationId.property.host_id.createdOn).toLocaleDateString()}
          ...
          <p className="text-base flex flex-row items-center gap-6">
              ...
              <span className="text-lg"> {new Date(complaint.reservationId.checkOutDate).toLocaleDateString()}
              </span>
            </p>

            <p className="text-sm mt-3 flex flex-row items-center gap-2"> <FaRegClock />
            3 Days left</p>
          </div>
         ...
         <div className="m-3 p-1">
          <span>You estimated a LKR {complaint.estimatedBudget} for this job</span>
         </div>
       )}
