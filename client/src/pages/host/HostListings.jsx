      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-transparent transform transition-transform duration-300 hover:scale-105 relative card-hover-border">
        <div className='flex w-full'>
            ...
            <div className="flex flex-col justify-between pl-6 w-2/3 overflow-hidden">
              <div>
                ...
                <div className="flex items-center mb-2">
                  ...
                  <p className="text-gray-700 overflow-hidden text-ellipsis whitespace-nowrap">{property.description}</p>
                </div>
                <div className="flex items-center mb-2">
            ...
            <div className='flex flex-col bg-grey-400 justify-around p-4 m-2 rounded-lg'>
              <button onClick={() => handleEdit(property._id)} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 flex items-center justify-center space-x-1 mb-0 w-full" > <FaEdit /> <span>Edit</span> </button>
              <button onClick={() => handleDelete(property._id)} className="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-700 flex items-center justify-center space-x-1 w-full" > <FaTrash /> <span>Delete</span> </button>
            </div>
...
function NoListings() {
  return (
    <div className="text-center mt-20">
      ...
      <Link to="/host/add-property" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 inline-flex items-center space-x-2">
        <FaPlus />
