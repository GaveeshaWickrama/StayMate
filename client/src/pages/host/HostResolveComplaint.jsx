...
//   }
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="w-full md:w-2/3 rounded-lg p-1 bg-white shadow">
          ...
          <div className="bg-white p-8 flex flex-col items-center ">
           <p className='text-lg font-bold mb-3'>Do you have any comments to add?</p>
           <textarea
  placeholder="Bio"
  className="textarea textarea-bordered textarea-md w-full max-w-xs"></textarea>
      ...
      <div>
<button  onClick={()=>handleResolve()} className='bg-blue-600 text-white p-4 rounded font-bold w-50 my-10 m-4'>Confirm</button>
