...
function GreetingBox({ name }) {
  return (
    <div className="bg-gradient-to-r from-blue-100 to-green-100 p-6 rounded-lg border border-gray-300 shadow-md mb-8">
...
function AdminDashboard() {
  ...
  return (
    <main
      className="p-6 min-h-screen bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300"
      style={{
    ...
    >
      ...
      <h3 className="text-4xl font-bold text-gray-800 mb-8 text-center">Dashboard</h3>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-8">
        <div className="bg-white shadow-lg p-6 rounded-lg flex flex-col items-center transform transition-transform duration-300 hover:scale-105">
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg flex flex-col items-center transform transition-transform duration-300 hover:scale-105">
          <FaUserTie className="text-6xl text-blue-500 mb-4" />
        ...
        <div className="bg-white shadow-lg p-6 rounded-lg flex flex-col items-center transform transition-transform duration-300 hover:scale-105">
          <FaHome className="text-6xl text-purple-500 mb-4" />
          <h3 className="text-xl font-semibold text-gray-700">Total Properties</h3>
          <p className="text-3xl font-bold text-gray-900">50</p> {/* Static data */}
        </div>
        <div className="bg-white shadow-lg p-6 rounded-lg flex flex-col items-center transform transition-transform duration-300 hover:scale-105">
          <FaCalendarCheck className="text-6xl text-orange-500 mb-4" />
          <h3 className="text-xl font-semibold text-gray-700">Upcoming Bookings</h3>
          <p className="text-3xl font-bold text-gray-900">25</p> {/* Static data */}
        </div>
      </div>
      ...
      <div className="flex justify-center mb-8">
        <div className="flex space-x-4">
          <button
            ...
            className={`px-6 py-3 rounded-lg font-semibold transition-colors duration-300 ${view === "monthly" ? "bg-blue-600 text-white shadow-lg" : "bg-white text-blue-600 border border-blue-600"} hover:bg-blue-700 hover:text-white`}
          >
            Monthly
          </button>
          <button
            onClick={() => setView("yearly")}
            className={`px-6 py-3 rounded-lg font-semibold transition-colors duration-300 ${view === "yearly" ? "bg-blue-600 text-white shadow-lg" : "bg-white text-blue-600 border border-blue-600"} hover:bg-blue-700 hover:text-white`}
          >
            Yearly
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white shadow-lg p-6 rounded-lg transform transition-transform duration-300 hover:scale-105">
